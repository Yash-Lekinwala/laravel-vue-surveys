  ...
  <div>
    <div>
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        Or
        <router-link :to="{name:'Login'}" class="font-medium text-indigo-600 hover:text-indigo-500"> Already Registered? Login Here </router-link>
      </p>
    </div>
    <form class="mt-8 space-y-6" @submit="register">
      ...
      <div class="rounded-md shadow-sm -space-y-px">
        ...
        <div>
          ...
          <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="off" required v-model="user.password_confirmation"
